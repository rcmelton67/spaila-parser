...
contextBridge.exposeInMainWorld("parserApp", {
  ...
  submitSupportReport:     (payload) => ipcRenderer.invoke("support:submit-report", payload || {}),
  listSupportReports:      ()        => ipcRenderer.invoke("support:list-reports"),
  readSupportReport:       (fp)      => ipcRenderer.invoke("support:read-report", fp),
  openSupportReportsFolder: ()       => ipcRenderer.invoke("support:open-reports-folder"),
  ...
  getDocumentsConfig:  ()        => ipcRenderer.invoke("documents:get-config"),
  updateDocumentsConfig:(payload) => ipcRenderer.invoke("documents:update-config", payload || {}),
  syncDocumentAsset:   (payload) => ipcRenderer.invoke("documents:sync-asset", payload || {}),
  ...
  getWorkspacePaths:   ()        => ipcRenderer.invoke("workspace:get-paths"),
  setWorkspaceRoot:    (newRoot) => ipcRenderer.invoke("workspace:set-root", newRoot),
