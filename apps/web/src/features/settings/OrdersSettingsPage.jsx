...
const DEFAULT_FIELDS = [
  ...
  { key: "billing_name", label: "Billing Name", visible: true, color: true, highlight: false, highlightColor: DEFAULT_HIGHLIGHT_COLOR },
  { key: "billing_address", label: "Billing Address", visible: false, color: false, highlight: false, highlightColor: DEFAULT_HIGHLIGHT_COLOR },
  { key: "billing_email", label: "Email", visible: false, color: false, highlight: false, highlightColor: DEFAULT_HIGHLIGHT_COLOR },
  { key: "phone_number", label: "Phone Number", visible: false, color: false, highlight: false, highlightColor: DEFAULT_HIGHLIGHT_COLOR },
  { key: "recipient_name", label: "Shipping Name", visible: true, color: true, highlight: false, highlightColor: DEFAULT_HIGHLIGHT_COLOR },
